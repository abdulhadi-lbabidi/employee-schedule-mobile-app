...
@lazySingleton
class GetAllArchivedWorkshopUseCase {
  final WorkshopRepository repository;

  GetAllArchivedWorkshopUseCase({required this.repository}); // ✅ استخدام الـ Repository الجديد


  DataResponse<GetAllWorkshopsResponse> call() async {
    return repository.getArchiveWorkshops();
  }
}
