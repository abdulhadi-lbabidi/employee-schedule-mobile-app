      ...
      body: BlocBuilder<WorkshopsBloc, WorkshopsState>(
        builder: (context, state) {
          ...
          if (state is WorkshopsLoaded) {
            final activeWorkshops = state.workshops
                .where((w) => !w.isArchived)
                .toList();
            final archivedWorkshops = state.workshops
                .where((w) => w.isArchived)
                .toList();
  ...
  Widget _buildWorkshopCard(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          "عدد العمال: ${workshop.employeeCount}",
          style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  style: TextStyle(color: theme.textTheme.bodyLarge?.color),
                  decoration: const InputDecoration(
                    labelText: "موقع الورشة",
                    hintText: "مثلاً: حلب الجديدة",
                  ),
                ),
                SizedBox(height: 5.h),
                TextField(
                ...
                OutlinedButton.icon(
                  onPressed: () async {
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const MapPickerWidget(),
                      ),
                    );
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              workshopsBloc.add(
                ToggleArchiveWorkshopEvent(workshopId, !isArchived),
              );
              Navigator.pop(context);
            },
            child: Text(
