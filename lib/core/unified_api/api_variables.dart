...
class ApiVariables {
  ...
  static Uri archiveRestoreAllEmployees() => _mainUri('/api/employees-archived/restore');
  static Uri archiveEmployee(String id) => _mainUri('/api/employees/$id');
  static Uri archiveRestoreEmployee(String id) => _mainUri('/api/employees/$id/restore');
  ...
  static Uri updateEmployeeArchive(String id) => _mainUri('/api/employees/$id/archive');
  static Uri updateHourlyRate(String id) => _mainUri('/api/employees/$id/hourly_rate');
  ...
  static Uri archiveRestoreWorkshop(String id) => _mainUri('/api/workshops/$id/restore');
  static Uri workshopEmployees(String id) => _mainUri('/api/admin/workshops/$id/employees');

  // --- Attendance ---
  static Uri getAttendances({Map<String, String>? params}) => _mainUri('/api/my-attendance/${AppVariables.user!.id}', params: params);
  ...
  static Uri postApproveLoans(int idlonas) => _mainUri('/api/loans/$idlonas/approve');
  static Uri postRejectLoans(int idlonas) => _mainUri('/api/loans/$idlonas/reject');
  static Uri postPayLoans(int idlonas) => _mainUri('/api/loans/$idlonas/pay');
  ...
  static Uri archiveRestoreLoans(String loanId) => _mainUri('/api/loans/$loanId/restore');
  static Uri archiveDeleteLoans(String loanId) => _mainUri('/api/loans/$loanId');
  static Uri getarchiveAllLoans() => _mainUri('/api/loans-archived');
  static Uri recordPayment(String loanId) => _mainUri('/api/admin/loans/$loanId/payments');
  ...
  // --- Rewards ---
  static Uri postRewards() => _mainUri('/api/rewards');
  static Uri getRewards() => _mainUri('/api/rewards');
  static Uri adminRewards() => _mainUri('/api/rewards'); // تم إضافة هذه الدالة
  static Uri getemPloyeeRewards(int idemployee) => _mainUri('/api/rewards/$idemployee');
  ...
  static Uri deleteNotification(String id) => _mainUri('/api/notifications/$id');
}
